...
const PrivacyPolicy: React.FC = () => {
  useEffect(() => {
    document.title = 'سياسة الخصوصية - تحويلاتي';
  }, []);
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            في <strong>تحويلاتي</strong>، خصوصيتك هي أثمن ما نزن. كما كان أجدادنا يحرصون على دقة <strong className="text-amber-700">المثقال</strong> وأمانة <strong className="text-amber-700">الذراع</strong>، نحن في عام 2026 نعتبر بياناتك أمانة لا تقبل القسمة على اثنين.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 mb-12 border border-amber-200">
          ...
          <p className="text-gray-700 leading-relaxed">
            أنت هنا لتحول الأرقام، ونحن هنا لنضمن أن رحلتك تبقى <strong>مجهولة الهوية تماماً</strong>. 
            لا نطلب اسمك، لا نطلب بريدك الإلكتروني، لا نطلب رقم هاتفك. ما تحوله هو بينك وبين الأرقام فقط.
          </p>
        </div>

        {/* المحتوى الرئيسي */}
        <div className="space-y-8">
          {/* القسم 1: البيانات التي نجمعها */}
          ...
          {/* القسم 2: إعلانات Google AdSense */}
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                لنساعد في الحفاظ على خدماتنا مجانية، نعرض إعلانات من خلال <strong>Google AdSense</strong>. هذه الإعلانات قد تستخدم ملفات تعريف الارتباط لعرض إعلانات ذات صلة باهتماماتك العامة.
              </p>
              <div className="bg-gray-50 p-4 rounded-xl">
                <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                  <span>🔗</span> معرفة المزيد
                </h3>
                <p className="text-sm text-gray-600 mb-2">
                  يمكنك الاطلاع على سياسة خصوصية Google من خلال الرابط التالي:
                </p>
                <a 
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex gap-3 items-start">
                  ...
                  <p className="text-gray-700">يمكنك استخدام جميع أدواتنا <strong>دون تسجيل دخول</strong></p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="text-green-500 text-xl">✓</span>
                  <p className="text-gray-700">يمكنك مسح بيانات التصفح من متصفحك في أي وقت</p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="text-green-500 text-xl">✓</span>
                  <p className="text-gray-700">يمكنك تعطيل ملفات تعريف الارتباط من إعدادات متصفحك</p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="text-green-500 text-xl">✓</span>
                  <p className="text-gray-700">لن نطلب منك أبداً معلوماتك الشخصية</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                جميع التحويلات تتم داخل متصفحك. البيانات لا تُرسل إلى خوادمنا إلا في حالات محدودة (مثل أسعار العملات)، وكل هذه الاتصالات مشفرة بتقنية <strong>SSL/TLS</strong>.
              </p>
          ...
          {/* القسم 5: التواصل - مع البريد الإلكتروني */}
          <section className="bg-gradient-to-br from-slate-50 to-gray-100 rounded-2xl p-8">
            ...
            <p className="text-gray-700 mb-4">
              إذا كان لديك أي سؤال حول سياسة الخصوصية أو كيفية تعاملنا مع البيانات، أو إذا كنت ترغب في الإبلاغ عن أي مشكلة تقنية، يمكنك التواصل معنا عبر:
            </p>
        ...
        <div className="mt-12 flex flex-wrap gap-3 justify-center">
          ...
          <Link to="/currency" className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition">
            تحويل العملات
          </Link>
